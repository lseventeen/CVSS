...
class _GridAttentionBlockND(nn.Module):
    ...
    def _concatenation(self, x, g):
        ...
        sigm_psi_f = nn.functional.interpolate(sigm_psi_f, size=input_size[2:], mode=self.upsample_mode)
...
class UnetUp3(nn.Module):
    def __init__(self, in_size, out_size, is_deconv, is_batchnorm=True,kernel_size=(2,2,2),stride=(2,2,2)):
        ...
        if is_deconv:
            ...
            self.up = nn.ConvTranspose3d(in_size, out_size, kernel_size=kernel_size, stride=stride, padding=(0,0,0))
        else:
...
class Att_UNet_3D(nn.Module):
    ...
    def __init__(self, feature_scale=2, num_classes=2, is_deconv=True, num_channels=3,
        ...
        self.up_concat1 = UnetUp3(filters[1], filters[0], self.is_deconv, self.is_batchnorm,kernel_size=(1,2,2),stride=(1,2,2))
