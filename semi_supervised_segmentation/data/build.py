...
def build_train_single_loader(config):
    train_dataset = label_dataset(config,images_path=config.DATASET.TRAIN_IMAGE_PATH, labels_path=config.DATASET.TRAIN_LABEL_PATH)
...
def build_test_loader(config):
    dataset = test_dataset(config,images_path=config.DATASET.TEST_IMAGE_PATH, labels_path=config.DATASET.TEST_LABEL_PATH)
...
def build_inference_loader(config):
    test_dataset = inference_dataset(config,images_path=config.DATASET.UNLABEL_IMAGE_PATH)
